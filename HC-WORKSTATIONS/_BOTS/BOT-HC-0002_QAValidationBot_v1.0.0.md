...
|--------|-------------|---------|
| Cloudflare Worker | POST /api/enroll | Receives scan requests from approval workflow |
...
- [ ] Cloudflare Worker endpoint configured and tested at api.hirecar.la/api/enroll
